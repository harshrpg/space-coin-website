    ...
    <div class="container is-max-desktop">
      <div class="content">
        ...
        <p class="subtitle is-size-6 has-text-justified">
          ...
          After careful experimentation and mathematical analysis, we are confident that <span class="title is-size-6">Space Coin Protocol</span> 
        will mitigate many of the troubles faced by other DeFi reflection and deflationary tokens.
        </p>
